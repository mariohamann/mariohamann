...
teaser: "Developing an activity overview in the style of GitHub's contribution graph to track my new year's resolution"
seo_noindex: false
seo_nofollow: false
      ...
      -
        ...
        attrs:
          ...
          values:
            ...
            size: xl
            caption: 'Overview of activity-graph Web Component'
    type: set_article
    enabled: true
  -
    id: lud919ip
      ...
      -
        ...
        attrs:
          ...
          values:
            ...
            size: xl
            caption: 'Overview of activity-graph pre-rendered by @enhance/ssr'
    type: set_article
    enabled: true
  -
    id: ludn7whi
      ...
      -
        ...
        attrs:
          ...
          values:
            ...
            size: xl
            caption: 'Overview of activity-graph pre-rendered by enhance-ssr-wasm'
    type: set_article
    enabled: true
  -
    id: lue6q4tz
